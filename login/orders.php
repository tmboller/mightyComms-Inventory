...
background: radial-gradient(circle, rgba(0,0,0,1) 0%, rgba(240,232,232,1) 17%, rgba(235,42,52,1) 28%, rgba(224,161,161,1) 49%, rgba(217,199,199,1) 58%, rgba(217,198,198,1) 69%, rgba(235,226,226,1) 85%);</style>
<ol class="breadcrumb">
		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="form-group">
			    <label type= "date" for="orderDate" class="col-sm-2 control-label">Order Date</label>
			    <div class="col-sm-10">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientName" name="clientName" placeholder="Supplier Name" Name" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->
			  <div class="form-group">
			  			...
			  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">			  				
			  				<td style="margin-left:20px;">
			  					...
			  					<select class="form-control" name="productName[]" id="productName<?php echo $x; ?>" onchange="getProductData(<?php echo $x; ?>)" >
			  						...
			  						<?php
			  							$productSql = "SELECT * FROM product WHERE active = 2 AND status = 1 AND quantity != 0";
